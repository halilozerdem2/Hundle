...
const stamp = (minutesAgo) => new Date(Date.now() - minutesAgo * 60 * 1000).toISOString();
const categorySeeds = {
    technology: [
        {
            id: 'tech-1',
            title: 'Google adds on-device Gemini Nano to Android 15 beta',
            description: 'Developers can now run the lightweight Gemini model locally, unlocking faster AI experiences without sending prompts to the cloud.',
        ...
        },
        {
            ...
            description: 'The latest Llama release brings stronger multilingual reasoning and image understanding to the open-source community.',
        ...
        },
        {
            ...
            description: 'New silicon partnerships and Windows experiences highlight how Copilot is coming to more endpoints.',
        ...
        },
        {
            ...
            description: 'The compact model is optimized for voice and vision workloads that need low latency.',
...
const seedData = Object.values(categorySeeds).flat();
...
const fetchNews = async (categories) => {
    ...
    const normalized = categories.reduce((acc, category) => {
